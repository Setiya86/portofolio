...
export default function Home() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    try {
      const response = await fetch("https://formsubmit.co/catursetiya89@gmail.com", {
        method: "POST",
        headers: {
  ...
  return (
    <main className="min-h-screen bg-black text-white font-sans scroll-smooth">
      ...
      <div className="pt-24 px-6 py-10">
        {/* Hero Section */}
        <motion.section className="flex flex-col md:flex-row gap-8 items-center justify-between mb-12 scroll-mt-20" variants={fadeIn} initial="hidden" whileInView="visible" viewport={{ once: false }}>
        ...
        {/* About Section */}
        <motion.section id="about" className="mb-12 scroll-mt-20" variants={fadeIn} initial="hidden" whileInView="visible" viewport={{ once: false }}>
        ...
        {/* Skill Section */}
        <motion.section id="skills" className="mb-12 scroll-mt-20" variants={fadeIn} initial="hidden" whileInView="visible" viewport={{ once: false }}>
        ...
        {/* Project Section */}
        <motion.section id="projects" className="mb-12 scroll-mt-20" variants={fadeIn} initial="hidden" whileInView="visible" viewport={{ once: false }}>
        ...
        {/* Certificate Section
        <motion.section id="certificates" className="mb-12 scroll-mt-20" variants={fadeIn} initial="hidden" whileInView="visible" viewport={{ once: false }}>
        ...
        {/* Contact Section */}
        <motion.section id="contact" className="mb-12 bg-color-white rounded p-10 max-w-2xl mx-auto scroll-mt-20" variants={fadeIn} initial="hidden" whileInView="visible" viewport={{ once: false }}>
